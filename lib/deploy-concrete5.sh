...
if [ $ret -eq 0 ] ; then
	...
	mv ./concrete5/* /home/$CUSTOM_USER/$PROFILE/DocumentRoot
	rm -rf $WORKDIR
else
...
chmod 0777 /home/$CUSTOM_USER/$PROFILE/DocumentRoot/packages
chmod 0777 /home/$CUSTOM_USER/$PROFILE/DocumentRoot/application/config
chmod 0777 /home/$CUSTOM_USER/$PROFILE/DocumentRoot/application/files
